...
export default function SearchBox(){
    ...
    return(
        <>
            <div id="search-box" className="search-box" onMouseOver={() => handleMouseOver()}>
                <div className="container">
                    ...
                    <ul className="list">
                        <li>
                            <div className="frame">
                                <div className="vh">
                                    <div className="t1">BUSINESS DEVELOPMENT MANAGER</div>
                                    <a target="_blank" href="https://t.me/Clicklead_HR_2" className="btn">Respond</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="frame">
                                <div className="vh">
                                    <div className="t1">DATA ANALYST</div>
                                    <a target="_blank" href="https://t.me/Clicklead_HR_2" className="btn">Respond</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="frame">
                                <div className="vh">
                                    <div className="t1">Head of Marketing</div>
                                    <a target="_blank" href="https://t.me/Clicklead_HR_2" className="btn">Respond</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="frame">
                                <div className="vh">
                                    <div className="t1">Affiliate</div>
                                    <a target="_blank" href="https://t.me/Clicklead_HR_2" className="btn">Respond</a>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div className="frame">
                                <div className="vh">
                                    <div className="t1">MEDIABUYER Google</div>
                                    <a target="_blank" href="https://t.me/Clicklead_HR_2" className="btn">Respond</a>
                                </div>
                            </div>
                        </li>
